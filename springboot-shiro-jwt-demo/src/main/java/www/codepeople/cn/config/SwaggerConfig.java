...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        ticketPar.name("Authorization")
                ...
                .required(false).build();//required表示是否必填，default value表示默认值
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //为当前包路径
                .apis(RequestHandlerSelectors.basePackage("www.codepeople.cn.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .version("1.0")
                //描述
                .description("springboot+shiro+jwt+activiti")
                .build();
    }
}